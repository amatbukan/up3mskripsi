...
<div id="page-wrapper">
	...
	<section class="content">
		...
		<div class="box-body table-responsive">
			...
			<?php
			$no=1;
			$qO=mysql_query("SELECT * FROM `penelitian_pengabdian` WHERE identitas1='$_SESSION[sesi_user]' OR identitas2='$_SESSION[sesi_user]' OR identitas3='$_SESSION[sesi_user]' OR identitas4='$_SESSION[sesi_user]' OR identitas5='$_SESSION[sesi_user]'");
