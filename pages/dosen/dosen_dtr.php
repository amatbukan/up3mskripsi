						...
						<div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <select class="form-control" name="jenisPenelitian" required>
								...
								<option value="5">Penelitian (Dosen)</option>
								<option value="4">Pengabdian Kepada Masyarakat (Dosen)</option>
							</select>
                          </div>
                        </div>
						<div class="form-group row">
...
<script>
	function showData() {
			...
			if (mhs_nim==mhs_nim2){
				alert("NIK Sudah Diinputkan");
				$("#mhs_nim2").val('');
				$("#mhs_nama2").val('');
				$("#mhs_nim2").focus();
			}else{
				$.post("pajax.php", { nim: ""+mhs_nim2+""}, 
				function(data){ 
