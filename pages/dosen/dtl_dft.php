                    ...
                    <div class="card-body">
					  <!-- Ketua -->
						...
						<div class="form-group row">
                          ...
                          <div class="col-sm-2">
                            <input type="text" class="form-control form-control-success" readonly="readonly" name="mhs_nim" value="<?=$qq->nik_dospem;?>">
                          </div>                          
						...
						<div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <a href="dosen_hs.php" class="btn btn-danger">Kembali</a>
                          </div>
                        </div>						
                          </div>
                        </div>
