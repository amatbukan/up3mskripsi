...
if($laporan == 'AND (tgl_serah_laporan = 0000-00-00)'){
	$lp =  "SELECT * FROM penelitian_pengabdian WHERE (jenis='4' OR jenis='5') AND (status='2' OR status='3' OR status='4') $laporan AND prodi='$prodi' ORDER BY id ASC";
}
else{
	$lp = "SELECT * FROM penelitian_pengabdian WHERE (YEAR(tgl_serah_laporan)='$tahun') AND (jenis='4' OR jenis='5') AND (status='5') $laporan AND prodi='$prodi' ORDER BY id ASC";
}
